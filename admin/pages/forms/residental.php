...
if(isset($_GET['delid'])){
  ...
  $dnk=mysqli_query($conn,"delete from residental where id='$id'");
  if($dnk=1){
                  ...
                  <tbody>
                      ...
                      <tr class="" style="">
                        ...
                        <a href="#"><button type="button" data-bs-toggle="modal" data-bs-target="#myModal"
                              class="btn btn-danger btn-md dnkd3" data-id="<?php echo $arr['id'] ?>" style="color: aliceblue"> <i
                                class="fas fa-pen"></i></button></a>

                                <a href="residental.php?delid=<?php echo $arr['id'];?>"><button type="button" class="btn btn-danger btn-md" onclick="confirm delete()" style="color: aliceblue"> <i
...
$('.dnkd3').click(function(){
  let dnkddd = $(this).data('id');
