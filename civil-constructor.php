          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title" style="color:#ffb600">Civil Constructor</h1>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="services.php">Services</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Civil Constructor</li>
                  </ol>
                </nav>
              </div>
            </div><!-- Col end -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content " style="margin-top:14%;">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Civil Constructor Form</h4>
