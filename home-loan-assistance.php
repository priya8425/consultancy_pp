...
if(isset($_POST['submit'])){
   ...
   $page_name='home-loan-assistance';
...
<body>
   <div class="body-inner">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="banner-heading">
                        <h1 class="banner-title" style="color:#ffb600;">Home Loan Assistance</h1>
                        <nav aria-label="breadcrumb">
                           <ol class="breadcrumb justify-content-center">
                              <li class="breadcrumb-item"><a href="#">Home</a></li>
                              <li class="breadcrumb-item"><a href="#">Company</a></li>
                              <li class="breadcrumb-item active" aria-current="page">Home Loan Assistance</li>
                           </ol>
                        </nav>
                     </div>
                  </div><!-- Col end -->
      ...
      <section id="main-container" class="main-container">
         <div class="container">
            <div class="col-lg-12">
               <h3 class="column-title" style="margin-top:5%">Home Loan Assistance</h3>
               <p>We will help you make a home loan process quick and simple. We are associated and have tie-up with several reputed banks and Financial Institutions through which we will get you loans at most competitive rates, So you can also be a proud home owner. Whether you are salaried or self-employed, we will assist you to get home loan for the purchase of flats, row houses, bungalows and even plots. We ensure for faster processing and affordable EMIs to make home loans the perfect choice for new or experienced buyers. We also offer expert legal and technical counselling to make the home buying process much easier. Let us lend you a helping hand in making your dream come true.</p>
