          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title" style="color:#ffb600">Home Loanr</h1>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-8">
            <?php
            $sql=mysqli_query($conn,"Select * from  services where page_name= 'home-loan'");
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content " style="margin-top:14%;">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Home Loan Form</h4>
