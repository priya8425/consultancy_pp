    ...
    <div class="container">
      <div class="row justify-content-between">
        ...
        <div class="col-lg-3 col-md-6 footer-widget mt-5 mt-md-0">
          ...
          <div class="row">&nbsp;&nbsp;&nbsp;
            <div>+91 9594617333</div>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div>+91 8291397897</div>
          </div><br>
          <div class="footer-widget">
          <h3 class="widget-title">Address</h3>
          <div class="details">
            Shop no. 61, Haware Nirmiti CHS 8-12, Sector 22, Plot No.15, Kamothe, Navi Mumbai -410206
          </div>
        </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="copyright-info text-center text-md-center">
            <span> &copy; <script>
              ...
              </script>, Designed &amp; Developed by <a href="http://tec.tectignis.in/">Tectignis It Solution
                Pvt.Ltd</a></span>
          </div>
        </div>
