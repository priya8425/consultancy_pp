  ...
  <div class="body-inner">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/homeloan.jpg" alt="service-image"
                  style="height:200px ">
              </div>
              <div class="d-flex">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/civil.jpg" alt="service-image"
                  style="height:200px ">
              </div>
              <div class="d-flex">
                <div class="ts-service-box-img">
          ...
          <div class="col-lg-4 col-md-6 mb-5">
            <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/medical.jpg" alt="service-image"
                  style="height:200px ">
              </div>
              <div class="d-flex">
                <div class="ts-service-box-img">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 text-center">
            <img loading="lazy" class="img-fluid" src="images/services/service8.png" alt="service-avater-image"
              ...
              <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;E-MARKETING&quot;]">
                <div class="project-img-container">
                  <a class="gallery-popup" href="images/projects/emarketing.jpg" aria-label="project-img">
                    <img class="img-fluid" src="images/projects/emarketing.jpg" alt="project-img"
                      style="height: 305px;">
              ...
              <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;REAL ESTATE&quot;]">
                <div class="project-img-container">
                  <a class="gallery-popup" href="images/projects/realestate1 (1).jpg" aria-label="project-img">
                    <img class="img-fluid" src="images/projects/realestate1 (1).jpg" alt="project-img"
                      style="height: 305px;">
                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                  </a>
                  <div class="project-item-info">
              ...
              <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;REAL ESTATE&quot;]">
                <div class="project-img-container">
                  <a class="gallery-popup" href="images/projects/realestate1 (2).jpg" aria-label="project-img">
                    <img class="img-fluid" src="images/projects/realestate1 (2).jpg" alt="project-img"
                      style="height: 305px;">
                    <span class="gallery-icon"><i class="fa fa-plus"></i></span>
                  </a>
                  <div class="project-item-info">
    ...
    <section class="content">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="column-title" style="text-align:center">Testimonials</h3>

            <div id="testimonial-slide" class="testimonial-slide">
              <div class="item">
                <div class="quote-item">
                  <span class="quote-text">
                    I’m updating some of my marketing materials and am in the process of collecting testimonials from
                    clients and wanted to ask you for one.
                  </span>
              ...
              <div class="item">
                <div class="quote-item">
                  <span class="quote-text">
                    our company generate 5 times more leads for less than we were spending before. He’s reliable,
              ...
              <div class="item">
                <div class="quote-item">
                  <span class="quote-text">
                    Would something like this be okay to use? Feel free to edit that and put it in your own words.
