...
================================================== -->
  ...
  <!-- Favicon
================================================== -->
  <link rel="icon" type="image/png" href="images/pp.webp">
    ...
    <div class="container">
        <div class="box-slider-content">
          <div class="box-slider-text">
              ...
              <p class="box-slide-description">Our end-to-end services support your organization at all stages of the content creation process.</p>
              <p>
  ...
  <div class="container">
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-5">
          <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/homeloan.jpg" alt="service-image" style="height:200px " >
              </div>
              <div class="d-flex">
                <div class="ts-service-box-img" >
                  
                    <img loading="lazy" src="images/icon-image/loan.png" alt="service-icon" style="width:65px " />
                </div>
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="service-single.html">Home Loan</a></h3>
                    <p>A home loan is a secured loan taken from a financial institution for the purpose of buying a residential property.Home loans can be availed from both banks and Non Banking Financial Companies (NBFCs).</p>
        ...
        <div class="col-lg-4 col-md-6 mb-5">
          <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/civil.jpg" alt="service-image" style="height:200px ">
              </div>
              <div class="d-flex">
                <div class="ts-service-box-img">
                    <img loading="lazy" src="images/icon-image/architect.png" alt="service-icon" style="width:65px "/>
                </div>
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="service-single.html">Civil Contractor</a></h3>
                    <p>Civil construction is the creation of infrastructure anything to do with water, earth, or transport & construction of the individuals and companies involved in the planning, creation, & designing of our infrastructure.</p>
                    <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                </div>
              </div>
          </div><!-- Service2 end -->
        ...
        <div class="col-lg-4 col-md-6 mb-5">
          <div class="ts-service-box">
              <div class="ts-service-image-wrapper">
                <img loading="lazy" class="w-100" src="images/services/medical.jpg" alt="service-image" style="height:200px ">
              </div>
              <div class="d-flex">
                <div class="ts-service-box-img">
                    <img loading="lazy" src="images/icon-image/healthcare.png" alt="service-icon" style="width:65px " />
                </div>
                <div class="ts-service-info">
                    <h3 class="service-box-title"><a href="service-single.html">Medical Health Check-up</a></h3>
                    <p> health check package which helps in the overall assessment of all the organs and systems of the body such as Heart, Liver, Kidneys, Thyroid, Urinary track infections, Diabetes, etc....</p>
                    <a class="learn-more d-inline-block" href="service-single.html" aria-label="service-details"><i class="fa fa-caret-right"></i> Learn more</a>
                </div>
              </div>
          </div><!-- Service3 end -->
    ...
    <div class="row">
        <div class="col-lg-4">
          <div class="ts-service-box d-flex">
              <div class="ts-service-box-img">
                <img loading="lazy" src="images/icon-image/vendor.png" alt="service-icon" style="width:65px ">
              </div>
          ...
          <div class="ts-service-box d-flex">
              <div class="ts-service-box-img">
                <img loading="lazy" src="images/icon-image/realestate.png" alt="service-icon" style="width:65px ">
              </div>
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="#">Real E-state</a></h3>
                <p>Real estate is property consisting of land and the buildings on it, along with its natural resources such as crops, water etc..</p>
              </div>
          </div><!-- Service 2 end -->
          ...
          <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                ...
                <p>A home loan is a secured loan taken from a financial institution for the purpose of buying a residential property.</p>
              </div>
          </div><!-- Service 3 end -->
          <div class="ts-service-box d-flex">
            <div class="ts-service-box-img">
              <img loading="lazy" src="images/icon-image/registration.png" alt="service-icon" style="width:65px ">
            </div>
            <div class="ts-service-box-info">
        ...
        <div class="col-lg-4 text-center">
          <img loading="lazy" class="img-fluid" src="images/services/service8.png" alt="service-avater-image" style="margin-top: 20px">
        </div><!-- Col end -->

        <div class="col-lg-4 mt-5 mt-lg-0 mb-4 mb-lg-0">
          <div class="ts-service-box d-flex">
              <div class="ts-service-box-img">
                <img loading="lazy" src="images/icon-image/engineer.png" alt="service-icon" style="width:65px ">
              </div>
              <div class="ts-service-box-info">
          ...
          <div class="ts-service-box d-flex">
              ...
              <div class="ts-service-box-info">
                ...
                <p>Civil construction is the creation of infrastructure involving anything to do with water, earth, or transport.</p>
              </div>
          </div><!-- Service 5 end -->

          <div class="ts-service-box d-flex">
              <div class="ts-service-box-img">
                <img loading="lazy" src="images/icon-image/certificate.png" alt="service-icon" style="width:65px ">
              </div>
              <div class="ts-service-box-info">
                <h3 class="service-box-title"><a href="#">ISO CERTIFICATION</a></h3>
                <p>ISO certification is a seal of approval from a third party that a company runs to one of the international standards developed and published.</p>
              </div>
          </div><!-- Service 6 end -->
          <div class="ts-service-box d-flex">
            <div class="ts-service-box-img">
            ...
            <div class="ts-service-box-info">
              ...
              <p> Health CHECK-UP helps in the overall assessment of all the organs and systems of the body such as Heart, Kidneys, Diabetes, etc...</p>
            </div>
        </div>
        </div><!-- Col end -->
    </div><!-- Content row end -->
        ...
        <div class="row shuffle-wrapper">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;E-MARKETING&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/emarketing.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/emarketing.jpg" alt="project-img" style="height: 305px;">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;ISO&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/iso2.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/iso2.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;REAL ESTATE&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/realestate1 (1).jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/realestate1 (1).jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;MEDICAL&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/eye.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/eye.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;CCTV&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/cctv2.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/cctv2.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;MEDICAL&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/heart.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/heart.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;CCTV&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/cctv1.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/cctv1.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;REAL ESTATE&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/realestate1 (2).jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/realestate1 (2).jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
          ...
          <div class="col-lg-4 col-sm-6 shuffle-item" data-groups="[&quot;ISO&quot;]">
            <div class="project-img-container">
              <a class="gallery-popup" href="images/projects/iso1.jpg" aria-label="project-img">
                <img class="img-fluid" src="images/projects/iso1.jpg" alt="project-img" style="height: 305px;">
                <span class="gallery-icon"><i class="fa fa-plus"></i></span>
              </a>
              <div class="project-item-info">
                <div class="project-item-info-content">
...
<!--                    <img loading="lazy" class="img-fluid" src="images/news/development.jpg" alt="img">-->
<!--                </a>-->
<!--              </div>-->
<!--              <div class="post-body">-->
<!--                <h4 class="post-title">-->
...
<!--              <div class="latest-post-media">-->
<!--                <a href="news-single.html" class="latest-post-img">-->
<!--                    <img loading="lazy" class="img-fluid" src="images/news/cctv.jpg" alt="img">-->
<!--                </a>-->
<!--              </div>-->
<!--              <div class="post-body">-->
<!--                <h4 class="post-title">-->
...
<!--              <div class="latest-post-media">-->
<!--                <a href="news-single.html" class="latest-post-img">-->
<!--                    <img loading="lazy" class="img-fluid" src="images/news/realestate.jpg" alt="img" style="height: 233px;">-->
<!--                </a>-->
<!--              </div>-->
<!--              <div class="post-body">-->
<!--                <h4 class="post-title">-->
