          ...
          <div class="row">
            <div class="col-lg-12">
              <div class="banner-heading">
                <h1 class="banner-title" style="color:#ffb600">Medical Health Checkup</h1>
                <nav aria-label="breadcrumb">
                  <ol class="breadcrumb justify-content-center">
                  <li class="breadcrumb-item"><a href="index.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="services.php">Services</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Medical Health Checkup</li>
                  </ol>
                </nav>
              </div>
            </div><!-- Col end -->
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-xl-8 col-lg-8">
            <?php
            $sql=mysqli_query($conn,"Select * from  services where page_name= 'medical-checkup'");
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content " style="margin-top:14%;">
        ...
        <div class="modal-header">
          <h4 class="modal-title">Medical Health Checkup Form</h4>
