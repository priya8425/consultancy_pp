...
<body>
   <div class="body-inner">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="banner-heading">
                        <h1 class="banner-title" style="color:#ffb600;">Property Valuation</h1>
      ...
      <section id="main-container" class="main-container">
         <div class="container">
            <div class="col-lg-12">
               <h3 class="column-title" style="margin-top:5%">Property Valuation</h3>
               <p>We have a dedicated team to evaluate each property in detail and get the most accurate value of any property. We believe that all properties are very much different and therefore we serve every client on one to one basis. We help our clients get their property's Market Value, Value-in-Use, Insurable Value and Liquidation Value. We determine these values through a process we have built over a period of years. Our property valuation services are in huge demand in Mumbai, Navi Mumbai and Thane.</p>
